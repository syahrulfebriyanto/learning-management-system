                ...
                <div class="card-body">
                    <form action="<?= base_url() ?>/admin/informasi/update" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="judul" type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>" id="judul" autofocus value="<?= (old('judul')) ? old('judul') : $informasi['judul']; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control <?= ($validation->hasError('konten')) ? 'is-invalid' : ''; ?>" name="konten" id="editor1" rows="10" cols="80"> <?= $informasi['konten']; ?>
                                </textarea>
