...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ubah Peserta Didik</h1>
    </div>
    <div class="row">
        ...
        <div class="col-xl-12 col-md-12 mb-12">
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <form action="<?= base_url() ?>/admin/student/update" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="form-group row">
                            <label for="nis" class="col-sm-2 col-form-label">NIS</label>
                            <div class="col-sm-3">
                                <input name="nis" type="text" class="form-control <?= ($validation->hasError('nis')) ? 'is-invalid' : ''; ?>" id="nis" value="<?= $student['nis']; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input name="nama" type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" id="nama" value="<?= $student['nama']; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input name="tahun_masuk" type="text" class="form-control <?= ($validation->hasError('tahun_masuk')) ? 'is-invalid' : ''; ?>" id="tahun_masuk" value="<?= $student['tahun_masuk']; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input name="tempat_lahir" type="text" class="form-control <?= ($validation->hasError('tempat_lahir')) ? 'is-invalid' : ''; ?>" id="tempat_lahir" value="<?= $student['tempat_lahir']; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <input class="form-control <?= ($validation->hasError('tanggal_lahir')) ? 'is-invalid' : ''; ?>" type="date" value="1990-08-19" id="tanggal_lahir" name="tanggal_lahir" value="<?= $student['tanggal_lahir']; ?>">
                            </div>
                        </div>
                        <hr>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input name="alamat" type="text" class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : ''; ?>" id="alamat" value="<?= $student['alamat']; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="foto"><?= $student['foto']; ?></label>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input name="status_id" type="text" class="form-control <?= ($validation->hasError('status_id')) ? 'is-invalid' : ''; ?>" id="status_id" value="<?= $student['status_id']; ?>">
